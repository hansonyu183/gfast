...
// arModel is a active record design model for table emp operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of emp.
	Table = "emp"
	// Model is the model object of emp.
	Model = &arModel{g.DB("erp").Table(Table).Safe()}
	// Columns defines and stores column names for table emp.
	Columns = struct {
		EmpId      string //   
        Name       string //   
        EasyCode   string //   
