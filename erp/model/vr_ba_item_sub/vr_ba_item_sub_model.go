...
// arModel is a active record design model for table vr_ba_item_sub operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of vr_ba_item_sub.
	Table = "vr_ba_item_sub"
	// Model is the model object of vr_ba_item_sub.
	Model = &arModel{g.DB("erp").Table(Table).Safe()}
	// Columns defines and stores column names for table vr_ba_item_sub.
	Columns = struct {
		AssNum            string //   
        BatchNo           string //   
        CostPrice         string //   
