...
// arModel is a active record design model for table ebm_brand operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of ebm_brand.
	Table = "ebm_brand"
	// Model is the model object of ebm_brand.
	Model = &arModel{g.DB("erp").Table(Table).Safe()}
	// Columns defines and stores column names for table ebm_brand.
	Columns = struct {
		EbmBrandId  string //   
        Name        string //   
        NoteInfo    string //
