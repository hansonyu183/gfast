...
// arModel is a active record design model for table fpres operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of fpres.
	Table = "fpres"
	// Model is the model object of fpres.
	Model = &arModel{g.DB("erp").Table(Table).Safe()}
	// Columns defines and stores column names for table fpres.
	Columns = struct {
		FpresId   string //   
        Name      string //   
        Model     string //   
