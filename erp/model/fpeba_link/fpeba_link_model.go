...
// arModel is a active record design model for table fpeba_link operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of fpeba_link.
	Table = "fpeba_link"
	// Model is the model object of fpeba_link.
	Model = &arModel{g.DB("erp").Table(Table).Safe()}
	// Columns defines and stores column names for table fpeba_link.
	Columns = struct {
		FpebaId  string //   
        EbaId    string //   
        State    string //
