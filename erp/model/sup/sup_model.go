...
// arModel is a active record design model for table sup operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of sup.
	Table = "sup"
	// Model is the model object of sup.
	Model = &arModel{g.DB("erp").Table(Table).Safe()}
	// Columns defines and stores column names for table sup.
	Columns = struct {
		SupId            string //   
        SupName          string //   
        EasyCode         string //   
        ...
        PreOut:          "pre_out",            
        ShouldOut:       "should_out",         
        TotBuyAmount:    "tot_buy_amount",     
        YearEarn:        "year_earn",          
        EmpId:           "emp_id",             
        State:           "state",              
