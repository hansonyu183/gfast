...
// arModel is a active record design model for table eba operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of eba.
	Table = "eba"
	// Model is the model object of eba.
	Model = &arModel{g.DB("erp").Table(Table).Safe()}
	// Columns defines and stores column names for table eba.
	Columns = struct {
		EbaId            string //   
        EbaName          string //   
        EasyCode         string //   
        ...
        HkPrice          string //   
        NoteInfo         string //   
        OweAmountLimit   string //   
        OweTimeLimit     string //   
        PreIn            string //   
        ShouldIn         string //   
        TotSellAmount    string //   
        YearEarn         string //   
        EmpId            string //   
        State            string //   
        CreateDate       string //   
        ...
        EMail:           "e_mail",             
        QqNo:            "qq_no",              
        OtherImNo:       "other_im_no",        
        BankAccount:     "bank_account",       
        BankAccountName: "bank_account_name",  
        BankName:        "bank_name",          
        RevenueNo:       "revenue_no",         
        NoTax:           "no_tax",             
        BillDay:         "bill_day",           
        PayDay:          "pay_day",            
        ...
        HkPrice:         "hk_price",           
        NoteInfo:        "note_info",          
        OweAmountLimit:  "owe_amount_limit",   
        OweTimeLimit:    "owe_time_limit",     
        PreIn:           "pre_in",             
        ShouldIn:        "should_in",          
        TotSellAmount:   "tot_sell_amount",    
        YearEarn:        "year_earn",          
        EmpId:           "emp_id",             
        State:           "state",              
