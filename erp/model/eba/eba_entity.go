...
// Entity is the golang structure for table eba.
type Entity struct {
    EbaId           string  `orm:"eba_id,unique"     json:"eba_id"`            //   
    EbaName         string  `orm:"eba_name,unique"   json:"eba_name"`          //   
    ...
    PayMonths       int     `orm:"pay_months"        json:"pay_months"`        //   
    ExPrice         int     `orm:"ex_price"          json:"ex_price"`          //   
    HkPrice         int     `orm:"hk_price"          json:"hk_price"`          //   
    ...
    PreIn           float64 `orm:"pre_in"            json:"pre_in"`            //   
    ShouldIn        float64 `orm:"should_in"         json:"should_in"`         //   
    TotSellAmount   float64 `orm:"tot_sell_amount"   json:"tot_sell_amount"`   //   
