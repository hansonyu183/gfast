...
// arModel is a active record design model for table vr_ba operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of vr_ba.
	Table = "vr_ba"
	// Model is the model object of vr_ba.
	Model = &arModel{g.DB("erp").Table(Table).Safe()}
	// Columns defines and stores column names for table vr_ba.
	Columns = struct {
		Amount                 string //   
        AssNo                  string //   
        BankCardPayAmount      string //   
        DateLmtEbm             string //   
        DateLmtRes             string //   
        Discount               string //   
        ...
        DrawPercent            string //   
        EbaId                  string //   
        EbaResOperFlag         string //   
        EbaType                string //   
        EbmBrandId             string //   
        EbmPreOperFlag         string //   
        EbmShouldOperFlag      string //   
        EdtId                  string //   
        EdtSiteId              string //   
        EmfCenterId            string //   
        EmfProcessId           string //   
        EmfShopId              string //   
        EmfVNo                 string //   
        GiftTicketPayAmount    string //   
        IoAmount               string //   
        ItemResEdtEbaOperFlag  string //   
        ItemResEdtFlag         string //   
        ItemResEdtOperFlag     string //   
        MainResEdtFlag         string //   
        MainResEdtOperFlag     string //   
        MemCardNo              string //   
        MemCardPayAmount       string //   
        MemCardSupport         string //   
        MioAccount             string //   
        MioMethodId            string //   
        MioOperFlag            string //   
        MioSubjectId           string //   
        ...
        ShouldAmount           string //   
        TargetEdtId            string //   
        VirEdtOperFlag         string //   
        VoucherId              string //
	}{
		Amount:                "amount",                      
        AssNo:                 "ass_no",                      
        BankCardPayAmount:     "bank_card_pay_amount",        
        DateLmtEbm:            "date_lmt_ebm",                
        DateLmtRes:            "date_lmt_res",                
        Discount:              "discount",                    
        DiscountAmount:        "discount_amount",             
        DrawAmount:            "draw_amount",                 
        DrawPercent:           "draw_percent",                
        EbaId:                 "eba_id",                      
        EbaResOperFlag:        "eba_res_oper_flag",           
        EbaType:               "eba_type",                    
        EbmBrandId:            "ebm_brand_id",                
        EbmPreOperFlag:        "ebm_pre_oper_flag",           
        EbmShouldOperFlag:     "ebm_should_oper_flag",        
        EdtId:                 "edt_id",                      
        EdtSiteId:             "edt_site_id",                 
        EmfCenterId:           "emf_center_id",               
        EmfProcessId:          "emf_process_id",              
        EmfShopId:             "emf_shop_id",                 
        EmfVNo:                "emf_v_no",                    
        GiftTicketPayAmount:   "gift_ticket_pay_amount",      
        IoAmount:              "io_amount",                   
        ItemResEdtEbaOperFlag: "item_res_edt_eba_oper_flag",  
        ItemResEdtFlag:        "item_res_edt_flag",           
        ItemResEdtOperFlag:    "item_res_edt_oper_flag",      
        MainResEdtFlag:        "main_res_edt_flag",           
        MainResEdtOperFlag:    "main_res_edt_oper_flag",      
        MemCardNo:             "mem_card_no",                 
        MemCardPayAmount:      "mem_card_pay_amount",         
        MemCardSupport:        "mem_card_support",            
        MioAccount:            "mio_account",                 
        MioMethodId:           "mio_method_id",               
        MioOperFlag:           "mio_oper_flag",               
        MioSubjectId:          "mio_subject_id",              
        MoneyFactor:           "money_factor",                
        MoneyType:             "money_type",                  
        PreAmount:             "pre_amount",                  
        ProjectId:             "project_id",                  
        RefType:               "ref_type",                    
        ShouldAmount:          "should_amount",               
        TargetEdtId:           "target_edt_id",               
        VirEdtOperFlag:        "vir_edt_oper_flag",           
