...
// arModel is a active record design model for table fpres_link operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of fpres_link.
	Table = "fpres_link"
	// Model is the model object of fpres_link.
	Model = &arModel{g.DB("erp").Table(Table).Safe()}
	// Columns defines and stores column names for table fpres_link.
	Columns = struct {
		FpresId  string //   
        ResId    string //   
        State    string //
