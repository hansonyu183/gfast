...
// arModel is a active record design model for table edt operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of edt.
	Table = "edt"
	// Model is the model object of edt.
	Model = &arModel{g.DB("erp").Table(Table).Safe()}
	// Columns defines and stores column names for table edt.
	Columns = struct {
		EdtId     string //   
        EdtName   string //   
        StopFlag  string //
