...
// arModel is a active record design model for table fpeba operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of fpeba.
	Table = "fpeba"
	// Model is the model object of fpeba.
	Model = &arModel{g.DB("erp").Table(Table).Safe()}
	// Columns defines and stores column names for table fpeba.
	Columns = struct {
		FpebaId   string //   
        TaxNo     string //   
        Name      string //   
