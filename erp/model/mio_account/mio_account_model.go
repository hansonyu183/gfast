...
// arModel is a active record design model for table mio_account operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of mio_account.
	Table = "mio_account"
	// Model is the model object of mio_account.
	Model = &arModel{g.DB("erp").Table(Table).Safe()}
	// Columns defines and stores column names for table mio_account.
	Columns = struct {
		AccountId     string //   
        AccountName   string //   
        Balance       string //   
