...
// Entity is the golang structure for table mio_account.
type Entity struct {
    AccountId    string  `orm:"account_id,unique" json:"account_id"`     //   
    AccountName  string  `orm:"account_name"      json:"account_name"`   //   
    Balance      float64 `orm:"balance"           json:"balance"`        //   
    BankAccount  string  `orm:"bank_account"      json:"bank_account"`   //   
    BankCode     string  `orm:"bank_code"         json:"bank_code"`      //   
    BankName     string  `orm:"bank_name"         json:"bank_name"`      //   
    InitBalance  float64 `orm:"init_balance"      json:"init_balance"`   //   
