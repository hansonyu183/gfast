...
// arModel is a active record design model for table vou operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of vou.
	Table = "vou"
	// Model is the model object of vou.
	Model = &arModel{g.DB("erp").Table(Table).Safe()}
	// Columns defines and stores column names for table vou.
	Columns = struct {
		Id             string //   
        No             string //   
        Date           string //   
